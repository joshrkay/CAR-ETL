...
from src.extraction.redactor import RedactedEntity, RedactionMode, redact_pii
...
class TestRedactionPropertyBased:
    ...
    def test_redact_no_email_leakage(self, text: str) -> None:
        """
    ...
    @settings(deadline=5000, max_examples=50)
    @given(st.text(min_size=1, max_size=1000))
    def test_redact_no_ssn_leakage(self, text: str) -> None:
        """
