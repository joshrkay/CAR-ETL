...
def test_service_role_tenant_creation():
    ...
    try:
        ...
        if verify_result.data:
            ...
            print("   [OK] Tenant verified:")
            print(f"        Name: {tenant['name']}")
            print(f"        Slug: {tenant['slug']}")
            print(f"        Environment: {tenant['environment']}")
            print(f"        Status: {tenant['status']}")
        else:
            print("   [FAIL] Tenant not found after creation")
            return False
    ...
    try:
        ...
        if update_result.data:
            ...
            print("   [OK] Tenant updated successfully")
    ...
    try:
        ...
        if not verify_deleted.data:
            print("   [OK] Tenant deletion verified (not found)")
        else:
    ...
    try:
        ...
        try:
            ...
            print("   [FAIL] Anon role was able to create tenant (RLS violation!)")
            ...
            if "permission denied" in error_msg.lower() or "row-level security" in error_msg.lower() or "policy" in error_msg.lower():
                print("   [OK] Anon role correctly blocked from creating tenant")
