...
def apply_migration(supabase: Client, migration_sql: str, migration_name: str) -> bool:
    ...
    try:
        ...
        try:
            ...
            print("  [INFO] Go to Supabase Dashboard → SQL Editor")
            print("  [INFO] Copy and paste the migration SQL")
            return False
...
def apply_migrations():
    ...
    for migration_file in migrations:
        ...
        try:
            ...
            print("  [INFO] Migration file read successfully")
            print("  [INFO] This migration needs to be applied manually")
            print("  [INFO] Steps:")
