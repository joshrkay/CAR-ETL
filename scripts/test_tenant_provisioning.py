...
def test_tenant_provisioning():
    ...
    try:
        ...
        print("   [OK] Linked admin to tenant")
            ...
            for user in users_list.users:
                if user.email == test_admin_email:
                    ...
                    try:
                        ...
                        print("   [OK] Linked existing admin to tenant")
                    except:
                        pass  # Already linked
                    break
        except:
    ...
    if response.status_code == 201:
        ...
        print("   [OK] Created tenant successfully:")
        ...
        if verify_result.data:
            ...
            print("   [FAIL] Tenant not found in database")
            return False
        ...
        try:
            ...
            if user_result.data:
                ...
                print("   [WARNING] Could not verify admin user link")
        except Exception as e:
        ...
        try:
            ...
            print("   [OK] Cleaned up test tenant")
        except Exception as e:
