...
# Import models
from src.db.models.control_plane import Base
...
# Get database URL from environment or connection manager
...
if database_url:
    ...
    try:
        ...
        config.set_main_option("sqlalchemy.url", manager.database_url)
    except Exception:
        pass
