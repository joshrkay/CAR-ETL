...
from src.extraction.prompts import build_document_type_detection_prompt, build_extraction_prompt
...
class ExtractedField(BaseModel):
    ...
    page: int | None = Field(None, ge=1, description="Page number where found")
    quote: str | None = Field(None, description="Supporting text quote")
