...
class AuditEvent(BaseModel):
    ...
    user_id: Optional[UUID] = Field(None, description="User UUID (null for system events)")
    event_type: str = Field(..., description="Event type (e.g., auth.login)")
    resource_type: Optional[str] = Field(None, description="Resource type (e.g., document)")
