...
class Entity(BaseModel):
    ...
    external_id: str | None = Field(None, description="Customer external identifier")
    parent_id: UUID | None = Field(None, description="Parent entity UUID")
...
class EntityRelationship(BaseModel):
    ...
    start_date: date | None = Field(None, description="Relationship start date")
    end_date: date | None = Field(None, description="Relationship end date")
    source_document_id: UUID | None = Field(
        None, description="Source document UUID"
    )
    created_at: datetime = Field(..., description="Creation timestamp")
